...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SENSORTYPE']._serialized_end=1187
  _globals['_SENSORERROR']._serialized_start=1189
  _globals['_SENSORERROR']._serialized_end=1287
