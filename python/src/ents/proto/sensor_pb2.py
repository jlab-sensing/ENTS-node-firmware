...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SENSORTYPE']._serialized_end=909
  _globals['_SENSORERROR']._serialized_start=911
  _globals['_SENSORERROR']._serialized_end=1009
