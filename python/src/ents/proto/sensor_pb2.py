...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SENSORTYPE']._serialized_end=1051
  _globals['_SENSORERROR']._serialized_start=1053
  _globals['_SENSORERROR']._serialized_end=1151
