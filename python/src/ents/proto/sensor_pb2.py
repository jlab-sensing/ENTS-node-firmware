...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SENSORTYPE']._serialized_end=955
  _globals['_SENSORERROR']._serialized_start=957
  _globals['_SENSORERROR']._serialized_end=1055
