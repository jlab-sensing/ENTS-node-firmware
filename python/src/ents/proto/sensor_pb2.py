...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SENSORTYPE']._serialized_end=1436
  _globals['_SENSORERROR']._serialized_start=1438
  _globals['_SENSORERROR']._serialized_end=1536
