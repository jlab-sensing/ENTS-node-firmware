...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SENSORTYPE']._serialized_end=1209
  _globals['_SENSORERROR']._serialized_start=1211
  _globals['_SENSORERROR']._serialized_end=1309
