...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SENSORTYPE']._serialized_end=871
  _globals['_SENSORERROR']._serialized_start=873
  _globals['_SENSORERROR']._serialized_end=971
