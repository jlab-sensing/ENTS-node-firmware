...
typedef struct _Measurement {
    ...
    union {
        ...
        VoltageDeltaMeasurement voltage_delta;
        CurrentDeltaMeasurement current_delta;
    } measurement;
} Measurement;

typedef struct _RepeatedMeasurement {
    /* Overall metadata */
    bool has_meta;
    MeasurementMetadata meta;
...
#define RepeatedMeasurement_init_default         {false, MeasurementMetadata_init_default, {{NULL}, NULL}}
...
#define RepeatedMeasurement_init_zero            {false, MeasurementMetadata_init_zero, {{NULL}, NULL}}
...
#define Measurement_voltage_tag                  8
#define Measurement_current_tag                  9
#define Measurement_voltage_delta_tag            10
#define Measurement_current_delta_tag            11
#define RepeatedMeasurement_meta_tag             1
#define RepeatedMeasurement_measurements_tag     2
...
X(a, STATIC,   ONEOF,    MESSAGE,  (measurement,voltage,measurement.voltage),   8) \
X(a, STATIC,   ONEOF,    MESSAGE,  (measurement,current,measurement.current),   9) \
X(a, STATIC,   ONEOF,    MESSAGE,  (measurement,voltage_delta,measurement.voltage_delta),  10) \
X(a, STATIC,   ONEOF,    MESSAGE,  (measurement,current_delta,measurement.current_delta),  11)
...
#define Measurement_measurement_voltage_MSGTYPE VoltageMeasurement
#define Measurement_measurement_current_MSGTYPE CurrentMeasurement
#define Measurement_measurement_voltage_delta_MSGTYPE VoltageDeltaMeasurement
#define Measurement_measurement_current_delta_MSGTYPE CurrentDeltaMeasurement

#define RepeatedMeasurement_FIELDLIST(X, a) \
X(a, STATIC,   OPTIONAL, MESSAGE,  meta,              1) \
X(a, CALLBACK, REPEATED, MESSAGE,  measurements,      2)
#define RepeatedMeasurement_CALLBACK pb_default_field_callback
#define RepeatedMeasurement_DEFAULT NULL
#define RepeatedMeasurement_meta_MSGTYPE MeasurementMetadata
#define RepeatedMeasurement_measurements_MSGTYPE Measurement
...
extern const pb_msgdesc_t RepeatedMeasurement_msg;
...
#define RepeatedMeasurement_fields &RepeatedMeasurement_msg
...
/* RepeatedMeasurement_size depends on runtime parameters */
