...
typedef EDU0157_INTF_RET_TYPE (*EDU0157_read_fptr_t)(uint8_t expected_cmd,
                                                     char *out, size_t max_len,
                                                     void *intf_ptr);
typedef EDU0157_INTF_RET_TYPE (*EDU0157_write_fptr_t)(uint8_t cmd,
                                                      const void *args,
                                                      uint16_t arg_len,
                                                      void *intf_ptr);
 ...
 *
 * @param dev Pointer to the EDU0157 device structure
 * @param key The key of the value to get *This is useless because they keys
 * dont work so i always call get all data.
