...
#define kDefaultAS7343DeviceID \
  0x81  // When polling the ID register, this should be returned on boot.
...
typedef enum {
  ...
  CH_GREEN_FY_555NM,    // Green (wide bandwidth) peak wavelength 555 nanometers
                        // (cycle 1)
  ...
  CH_LIGHT_BLUE_F3_475NM,  // Light Blue peak wavelength 475 nanometers (cycle
                           // 2)
  ...
  CH_GREEN_F5_550NM,  // Green (Narrow bandwidth) peak wavelength 550 nanometers
                      // (cycle 3)
...
#define ksfAS7343RegATime \
  0x81  // Register Address, register is a single uint8_t.
typedef uint8_t sfe_as7343_reg_atime_t;

#define ksfAS7343RegWTime \
  0x83  // Register Address, register is a single uint8_t.
...
#define ksfAS7343RegAzConfig \
  0xDE  // Register Address, register is a single uint8_t.
typedef uint8_t sfe_as7343_reg_az_config_t;

#define ksfAS7343RegFdTime1 \
  0xE0  // Register Address, register is a single uint8_t.
...
#define ksfAS7343RegFifoLvl \
  0xFD  // Register Address, register is a single uint8_t.
