 ...
 *
 * @param pAllocRamBuffer pointer used to store a FLASH page in RAM when partial
 ...
 *
 * @param pDestination pointer of flash address to write. It has to be 8 bytes
 * aligned.
 ...
 * @return FLASH_IF_StatusTypedef status
 */
FLASH_IF_StatusTypedef FLASH_IF_Write(void *pDestination, const void *pSource,
                                      uint32_t uLength);

/**
 * @brief This function reads a amount of data from flash and copy into the
 * output data buffer
 *
 ...
 * @return FLASH_IF_StatusTypedef status
 */
FLASH_IF_StatusTypedef FLASH_IF_Read(void *pDestination, const void *pSource,
                                     uint32_t uLength);

/**
 * @brief This function erases a amount of internal or external flash pages
