 ...
 * When set to 00,00,00,00,00,00,00,00 DevEui is automatically set with a value
 * provided by MCU platform
 */
 ...
 * When set to 00,00,00,00 DevAddr is automatically set with a value provided by
 * MCU platform
 */
...
#define SESSION_KEYS_LIST                                                      \
  {                                                                            \
       ...
       */                                                                      \
      .KeyID = J_S_INT_KEY,                                                    \
      .KeyValue = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
      ...
      {                                                                        \
           ...
           */                                                                  \
          .KeyID = J_S_ENC_KEY,                                                \
          .KeyValue = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,   \
      ...
      {                                                                        \
          ...
          .KeyValue = {0x2B, 0x7E, 0x15, 0x16, 0x28, 0xAE, 0xD2, 0xA6, 0xAB,   \
