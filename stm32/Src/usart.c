...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PC0     ------> LPUART1_RX
    */
    GPIO_InitStruct.Pin = SDI12_TX_Pin|SDI12_RX_Pin;
  ...
  */
    ...
    PA2     ------> USART2_TX
    */
    GPIO_InitStruct.Pin = USART2_RX_CP2102_Pin|USART2_TX_CP2102_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PC0     ------> LPUART1_RX
    */
    HAL_GPIO_DeInit(GPIOC, SDI12_TX_Pin|SDI12_RX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA2     ------> USART2_TX
    */
    HAL_GPIO_DeInit(GPIOA, USART2_RX_CP2102_Pin|USART2_TX_CP2102_Pin);
