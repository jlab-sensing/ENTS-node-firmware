...
parser = argparse.ArgumentParser(
    description="Generate and plot a sine wave voltage signal."
)
parser.add_argument(
    "--frequency",
    type=float,
    default=1.0,
    help="Frequency of the sine wave in Hz (default: 1 Hz)",
)
parser.add_argument(
    "--sample_rate",
    type=int,
    default=100,
    help="Number of samples per second (default: 100 Hz)",
)
parser.add_argument(
    "--duration",
    type=float,
    default=1.0,
    help="Duration of the signal in seconds (default: 1 second)",
)
parser.add_argument(
    "--output_file",
    type=str,
    default="voltage_signal.txt",
    help="Output file to save the voltage signal (default: voltage_signal.txt)",
)
